...
def overwrite_models_init_file():
    """
...
def update_console_to_remove_main():
    """
...
def main():
    ...
    backup_console_file()
    backup_models_init_file()
    overwrite_models_init_file()
    update_console_to_remove_main()

    my_console = create_console()
    run_tests(my_console)
